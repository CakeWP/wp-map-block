...
jQuery(document).ready(function () {
  const WPMapBlockRender = (element, ID, Settings) => {
    ...
    if (Settings.map_marker.length) {
      config.center = [Settings.map_marker[Settings.center_index].lat, Settings.map_marker[Settings.center_index].lng];
    }
    ...
    Settings.map_marker.forEach(function (item, index) {
      ...
      if (item.images.length > 0) {
        ...
        imageWrapper.classList.add("popup-image-wrapper"); // Slicing initial 4 images.
  ...
  if (jQuery(".wpmapblockrender").length) {
    jQuery(".wpmapblockrender").each((index, element) => {
      ...
      WPMapBlockRender(element, Element.attr("ID"), JSON.parse(Element.attr("data-settings")));
    });
  }
});
...
/******/ })()
;
//# sourceMappingURL=wpmapblock-frontend.core.min.js.map